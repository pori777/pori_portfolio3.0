<?php get_header() ;?>
    <main>
        ...
        <section id="about" class="p-section--about fade">
        ...
        <section id="works" class="p-section--post fade">
        ...
        <section id="blog" class="p-section--post fade">
        ...
        <section id="contact" class="p-section--contact fade">
